...
# ---------------------------------------------------------------------------- #
#                         class for birthday selection                         #
# ---------------------------------------------------------------------------- #
class BdayDropdown(nextcord.ui.Select) :

    def __init__(self, name: str) :
        # create the two options with the given name and style stored in value
    ...
    async def callback(self, interaction : Interaction) :
        # name and style are stored in value
        print(self.values[0])
...
# ---------------------------------------------------------------------------- #
#                       class for birthday selection view                      #
# ---------------------------------------------------------------------------- #
